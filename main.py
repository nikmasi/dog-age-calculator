...
def draw_howOldLabel():
    myfont = pygame.font.SysFont("monospace", 22)
    label = myfont.render("How old is your dog in human years?", 1, 'black')
    window.blit(label, (width / 2-label.get_width()/2, height / 3-label.get_height()/2))

def draw_questionLabel():
    myfont = pygame.font.SysFont("monospace", 22)
    label = myfont.render("How old is your dog?", 1, 'black')
    window.blit(label, (width / 2 - label.get_width() / 2, height / 3 - label.get_height() / 2))

def draw_year_month():
    myfont = pygame.font.SysFont("monospace", 12)
    label = myfont.render("year   month", 1, 'black')
...
def draw_resultLabel(text1,text2,checklab):
    myfont = pygame.font.SysFont("monospace", 22)
    myfont2= pygame.font.SysFont("monospace", 18)
    label = myfont2.render("The results", 1, 'green')
    label2= myfont.render("In human years your dog is", 1, 'black')
    window.blit(label, (width / 2 - label.get_width() / 2, height / 6 - label.get_height() / 2))
    window.blit(label2, (width / 2 - label2.get_width() / 2, height / 3 - label2.get_height() / 2))
...
def third_window(text1,text2,checklab):
    while True:
        ...
        draw_resultLabel(text1,text2,checklab)
...
def draw_HowIbs():
    myfont = pygame.font.SysFont("monospace", 22)
    label = myfont.render("Size of dog?", 1, 'green')
    window.blit(label, (width / 2 - label.get_width() /2, height / 6 - label.get_height()/2 ))
